...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Rectangle rect = new Rectangle(rng.Next(1,20), rng.Next(1,20));

            Console.WriteLine("Width: " + rect.GetWidth() + "; Height: " + rect.GetHeight() );
            
            Console.WriteLine("Area of the rectangle is " + rect.GetArea());

            Console.WriteLine("Aspect ratio: " + rect.GetAspectRatio());
            
            if (rect.GetAspectRatio() == 1) Console.WriteLine("Square");
